...
<div class="mb-8">
    <nav class="flex mb-4" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <li class="font-medium text-gray-900">Add Employee</li>
        </ol>
    </nav>
    <h1 class="text-2xl font-bold text-gray-900">Add New Employee</h1>
    <p class="mt-1 text-sm text-gray-500">Fill in the details below to add a new employee record.</p>
</div>
...
<div class="bg-white rounded-xl shadow ring-1 ring-gray-200">
    <form method="POST" action="{{ route('employees.store') }}">
        ...
        <div class="flex items-center justify-end gap-x-3 border-t border-gray-200 px-6 py-4 sm:px-8">
            <a href="{{ route('employees.index') }}" class="rounded-lg px-4 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-100 transition">Cancel</a>
